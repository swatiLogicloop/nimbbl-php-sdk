...
class NimbblRefund extends NimbblEntity implements JsonSerializable
{
    ...
    public function initiateRefund($attributes = array())
    {
        ...
        $response = $nimbblRequest->universalRequest('POST', '/api/v2/refund', $attributes);
    ...
    {
        $nimbblRequest = new NimbblRequest();
        $oneEntity = $nimbblRequest->request('GET', '/api/v2/fetch-refund/' . $id);
    ...
    public function retrieveMany($options = array())
    {
        ...
        $nimbblRequest = new NimbblRequest();
        $manyEntities = $nimbblRequest->request('GET', '/api/refunds/many?f=' . $f . '&pt=no');
    ...
    {
        $nimbblRequest = new NimbblRequest();
        $manyEntities = $nimbblRequest->request('GET', '/api/v2/order/fetch-refunds/' . $id);
    ...
    {
        $nimbblRequest = new NimbblRequest();
        $manyEntities = $nimbblRequest->request('GET', '/api/v2/transaction/fetch-refunds/' . $id);
